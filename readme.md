...
1. Сборка проекта;
2. Запуск тестов;
3. Копирование артефакта, полученного в результате сборки, на сервер для дальнейшей регистрации и запуска сервиса;
...
##################################################################################
##################################################################################
## Ниже представлен оригинальный README.md проекта
##################################################################################
##################################################################################
